...
APPENDDEF(`confINCDIRS', ``-I/usr/include/sasl -I/usr/local/include/openssl'')
APPENDDEF(`confLIBDIRS', ``-L/usr/lib/sasl2 -L/usr/local/lib'')
APPENDDEF(`confLIBDIRS', ``-Wl,-rpath=/usr/lib/sasl2 -Wl,-rpath=/usr/local/lib'')
